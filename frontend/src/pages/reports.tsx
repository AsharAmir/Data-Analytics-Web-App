        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center text-xs text-gray-500">
              ...
              {menuItem.type === 'dashboard' ? 'Dashboard Section' : 'Report Section'}
            </div>
          </div>
          <div className="ml-4">
          ...
          {menu && reports.length > 0 ? (
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Click on any report to open it in a new tab with full data analysis capabilities.
                </p>
              </div>
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Select a section to view all reports within that category.
                </p>
              </div>
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                {selectedSection ? `No reports in ${selectedSection}` : 'No reports available'}
              </h3>
