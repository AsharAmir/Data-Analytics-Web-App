          ...
          <div className="px-8 py-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-1">Real-time insights and comprehensive reporting</p>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 flex items-center space-x-2 shadow-lg hover:shadow-xl"
                >
                  <TrendingIcon />
